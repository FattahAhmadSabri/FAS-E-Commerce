        ...
        <div className="bg-white">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="lg:col-span-1 max-auto max-w-2x1 px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Fasco</h1>
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>
                                Men's Cotton Linen Checked ONLY Long Kurta
                            </h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <p className='opacity-50 text-sm'>5999 Ratings</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-500 hover:text-indigo-700'>5000 Reviews</p>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <p className='opacity-60'>75254</p>
                                </div>
                ...
                <section className='pt-10'>
                    ...
                    <div className='flex flex-wrap space-x-3 space-y-10'>
