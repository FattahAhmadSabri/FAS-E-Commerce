                      ...
                      {({ open }) => (
                        <>
                          ...
                          <DisclosurePanel className="pt-6">
                            <div className="space-y-4">
                              <FormControl>
                                <RadioGroup aria-labelledby="demo-radio-buttons-group-label" defaultValue="female" name="radio-buttons-group"></RadioGroup>
                              </FormControl>

                              {section.options.map((option, optionIdx) => (
                                <FormControlLabel onChange={(e)=>handleRadioFilter(e, section.id)} key={option.id} value={option.value} control={<Radio />} label={option.label} />
                              ))}
                            </div>
                          </DisclosurePanel>
                        </>
